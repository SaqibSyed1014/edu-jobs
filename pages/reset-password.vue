...
import CheckDisabledIcon from "assets/icons/tick-disabled.svg";
import ArrowLeftIcon from "assets/icons/arrow-left.svg";
</script>

<template>
  <div class="reset-password-form overflow-hidden">
  <div class="relative">
      ...
      <div class="flex flex-col gap-8 z-10 max-w-[360px] lg:w-full">
        <div class="flex flex-col gap-6 items-center">
          ...
          <div class="flex flex-col gap-3 items-center">
            <h2 class="text-3xl text-center font-bold text-gray-800">Set new password</h2>
            <p class="text-black-light font-normal text-center">Your new password must be different than your last password.</p>
          </div>
        </div>
        <div>
          <form class="flex flex-col gap-6">
            <div class="form-control">
              <label class="font-medium mb-1.5 text-sm" for="password">Password</label>
              <input class="form-input" id="password" type="password" placeholder="Enter your password" />
            </div>
            <div class="form-control">
              <label class="font-medium mb-1.5 text-sm" for="confirm-password">Confirm password</label>
              <input class="form-input" id="confirm-password" type="password" placeholder="Enter your confirm password" />
            </div>
            <div class="flex flex-col gap-y-1.5 text-sm">
              <div class="flex flex-col gap-3 items-start self-stretch">
                <div class="flex gap-2 items-center self-stretch">
                  <CheckDisabledIcon class="w-5 h-5" />
