      ...
      <section class="py-16 md:py-25">
        <div class="container md:px-8">
          <div class="text-center mx-auto w-full max-w-3xl md:mb-16">
            ...
            <p class="text-black-light md:text-xl font-normal mb-12">Subscribe to learn about new product features, the
            ...
            <form class="w-full mx-auto max-w-md text-left">
              <div class="flex flex-col md:flex-row items-start gap-4">
                <div class="w-full">
                  ...
                  <p class="font-normal text-sm mt-1.5">We care about your data in our <a href=""
